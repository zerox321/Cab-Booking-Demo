...
import com.eramint.data.Constants.confirmViewConstant
import com.eramint.data.Constants.driverIsComingConstant
import com.eramint.data.Constants.dropOffViewConstant
import com.eramint.data.Constants.padding
    ...
    private suspend fun getMap(): GoogleMap? {
        if (mMap == null) {
            ...
            mMap?.let { map ->
                ...
                viewModel.mapUtility.setMapStyle(
                    map = map,
                    context = this,
            ...
            confirmHome.run {
                ...
                selectBT.setOnClickListener {
                    ...
                    val model = InProgressModel(
                        ...
                        tripID = 1,
                        tripState = driverIsComingConstant,
                        price = "200 EGP",
                        rideType = "Go اوفر ",
